...
public static class Real3DPrefabBuilder
{
    ...
    {
        EnsureFolders();AssetDatabase.Refresh(ImportAssetOptions.ForceSynchronousImport);
        ...
        Save(FindBest(Role.Boss),OutputRoot+"/Characters/Boss.prefab",true);
        ...
        Save(FindBest(Role.Floor),OutputRoot+"/Environment/Floor.prefab",false);
