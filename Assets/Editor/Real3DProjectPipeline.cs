...
public static class Real3DProjectPipeline
{
    ...
    public static void Validate(){
        ...
        string scenePath="Assets/Scenes/Main.unity";bool sceneOk=File.Exists(scenePath);Debug.Log($"REAL 3D VALIDATION: required {ok}/{required.Length}, source models {models}, animation clips {anims}, main scene {sceneOk}");
