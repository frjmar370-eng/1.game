...
public static class FirstPlayableScene
{
    ...
    public static bool BuildSceneForBuild(){ return BuildScene(true); }

    static bool BuildScene(bool force){
        if(!force && File.Exists(ScenePath)) return true;
        if(!AssetExists("Assets/Art/Environment/CityKit.obj") || !AssetExists("Assets/Art/Characters/Hero.obj"))
        {
            Debug.LogError("SHOTGUN 3D: required CityKit.obj or Hero.obj is missing.");
            return false;
        }
        ...
        if(cityPrefab==null){ Debug.LogError("SHOTGUN 3D: CityKit.obj could not be imported as a GameObject."); return false; }
        ...
        if(heroPrefab==null){ Debug.LogError("SHOTGUN 3D: Hero.obj could not be imported as a GameObject."); return false; }
        ...
        Debug.Log("SHOTGUN 3D: Main.unity generated successfully.");
        return true;
    }
    ...
    static void CreateHUD(){
        ...
        Text("HP  ██████████  100",new Vector2(-300,-42),new Vector2(500,60),28,FontStyle.Bold);
        Text("12 / 48",new Vector2(-70,55),new Vector2(260,70),36,FontStyle.Bold);
        ...
        var fire=Panel(new Vector2(-90,115),new Vector2(150,150),new Color(1,.18f,.12f,.75f),"FIRE"); fire.AddComponent<MobileFireButton>(); Text("FIRE",new Vector2(-90,115),new Vector2(150,150),25,FontStyle.Bold);
        var jump=Panel(new Vector2(-270,115),new Vector2(120,90),new Color(.15f,.55f,1,.72f),"JUMP"); jump.AddComponent<MobileJumpButton>(); Text("JUMP",new Vector2(-270,115),new Vector2(120,90),19,FontStyle.Bold);
        Text("RELOAD",new Vector2(-270,255),new Vector2(180,65),20,FontStyle.Bold);
    }
