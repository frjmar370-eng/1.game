...
public class GameFlow : MonoBehaviour
{
    ...
    void Start(){
        ...
        DifficultySystem.Instance.SetWave(round);
        SpawnPickups(4);
    ...
    void BeginNextRound(){
        ...
        transitioning=true;nextRoundAt=Time.time+1.2f;
    ...
    void SpawnRoundTargets(int count){
        ...
        for(int i=0;i<count;i++){
            ...
            if(FindObjectOfType<CombatPresentation3D>())FindObjectOfType<CombatPresentation3D>().Attach(d);
        }
    }
    ...
    void RefreshEnemyPresentation(){
        ...
        foreach(TargetDummy d in FindObjectsOfType<TargetDummy>())cp.Attach(d);
    }
